# HOMEOPATHIC CLINIC SaaS - Environment Variables (Simplified Scope)
...
# ============================================
# OpenAI (Optional - for patient summary and WhatsApp analysis)
OPENAI_API_KEY=
...
## Removed Variables (Simplified Scope)
...
### Voice Consultation (Removed)
- VOICE_ENABLED
- VOICE_MAX_DURATION
- VOICE_FORMAT
- VOICE_BITRATE
- RAW_AUDIO_RETENTION_HOURS

### Notebook OCR (Removed)
- OCR_ENABLED
- OCR_LANGUAGE
- OCR_CONFIDENCE_THRESHOLD
- NOTEBOOK_ORIGINAL_RETENTION_DAYS

### Complex AI Artifacts (Removed)
- AI_ARTIFACT_RETENTION_DAYS
- AI_ARTIFACT_EXPIRY_HOURS
- AI_REVIEW_REQUIRED
...
FEATURE_AI_WHATSAPP=false     # WhatsApp message analysis
```
...
4. Remove unused variables (consent, voice, OCR, mobile)
5. Update application code to use new variables
